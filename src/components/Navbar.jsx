...
const Navbar = () => {
 ...
 useEffect(() => {
  ...
  return (
    <div>
    {scrollNav ? <NavbarScroll/> : '' }
      <div className="container xl:max-w-[1200px] m-auto  max-sm:max-w-[640px] font-secondaryHead ">
      <div className="row justify-between py-4">
          <ul className='row justify-center space-x-5'>
            <li><span className="bi bi-facebook hover:text-hover cursor-pointer transition"></span></li>
            <li><span className="bi bi-twitter hover:text-hover cursor-pointer transition"></span></li>
            <li><span className="bi bi-pinterest hover:text-hover cursor-pointer transition"></span></li>
            <li><span className="bi bi-linkedin hover:text-hover cursor-pointer transition"></span></li>
          </ul>
          <ul className="flex items-center justify-center space-x-5 max-xl:space-x-4 max-sm:hidden">
            
            <li onClick={() => navigate('/delivery')} className=' text-sm cursor-pointer transition font-semibold hover:text-hover '>
           Wishlist
          </li>
          <li onClick={() => navigate('/delivery')} className=' text-sm cursor-pointer transition font-semibold hover:text-hover '>
           Cart
         ...
         {/* Navbar */}
        <nav className="bg-secondary w-full px-8 z-50 relative shadow-2xl row justify-between max-xl:px-6 max-xl:py-4 max-sm:px-4 max-sm:py-3">
            {/* Logo */}
      ...
      <ul className='row justify-center gap-5 max-xl:gap-3'>
        ...
        <li className='border-2 flex items-center justify-center relative  w-17 h-16 group  border-border cursor-pointer hover:bg-hover transition max-xl:w-15 max-xl:h-14  max-xsm:hidden'>
            <span className='flex items-center justify-center w-4 h-4 bg-hover rounded-full text-[12px] text-black font-[poppins] font-bold absolute left-[22%] top-[22%] group-hover:bg-white group-hover:text-hover transition'>0</span>
